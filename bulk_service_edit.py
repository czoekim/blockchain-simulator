...
def bulk_service(event_queue, service_times, b, N, queue_length,server_busy):
...
for b in block_sizes:
    b = round(b / average_transaction_size)
    event_queue = []
    event_time = 0
    queue_length = 0
    ...
    departure_times = bulk_service(event_queue, service_times, b, N, queue_length, server_busy)
...
plt.plot(block_sizes, sim_times, 'or')
plt.ylim([0,2000])
